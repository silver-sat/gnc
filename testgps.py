...
while True:
	...
	print
	if False and len(index_values) > 0:
	    if first:
	        fig1 = figure()	    
		ax1 = fig1.add_subplot(1,1,1)
	        ax1.plot([-1000,1000],[0,0],'g--')
	        ax1.plot([-1000,1000],[180,180],'g--')
	        ax1.plot([-1000,1000],[-180,-180],'g--')
	        ax1.set_ylim([-360,360])
		fig2 = figure()
		ax2 = fig2.add_subplot(1,1,1) 
		first = False	    
	    ax1.plot(index_values[-2:],track_values[-2:],'b.')
	    ax1.set_xlim([0,max(index_values)+1])
	    fig1.savefig('testgps.png')	    

	    ax2.plot(lat_values[-1:],lon_values[-1:],'b.')
	    fig2.savefig('testgps.yeet.png')	    
